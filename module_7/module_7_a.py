# module_7_b Форматирование строк.
...
Комментарии к заданию:
    ...
    Переменные challenge_result, tasks_total, time_avg можно задать вручную или рассчитать. Например,
    для challenge_result:
...
# Использование format()
string3 = "Команда Волшебники данных решила задач: {}!".format(score2)
string4 = "Волшебники данных решили задачи за {} с!".format(team1_time)

# Использование f-строк
string5 = f"Команды решили {score1} и {score2} задач."
string6 = f"Результат битвы: {challenge_result}"
string7 = (f"Сегодня было решено {tasks_total} задач, "
